...
def main(args):
    ...
    train_dataloader = DataLoader(train_data, batch_size=args.batch_size,# len(labels["intent_labels"]),# args.batch_size,
    ...
    # loss_fnc = nn.CrossEntropyLoss(ignore_index=-100)
    ...
    for epoch in range(args.n_epochs):
        ...
        if res['intent_acc'] >= best_score['intent_acc']:
            best_score = res
            best_epoch = epoch + 1
